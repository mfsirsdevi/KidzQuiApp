...
<cfif SESSION.isLogged EQ "false">
      <cflocation url="#request.webRoot#index.cfm" addToken="false"></cflocation>
    </cfif>


<cfinclude template= "#request.webRoot#views/includes/header.cfm">

<cfinclude template= "#request.webRoot#views/includes/maintemplate.cfm">
    <!-- page content -->
        ...
        <!-- /page content -->
<cfinclude template="#request.webRoot#views/includes/footer.cfm">
